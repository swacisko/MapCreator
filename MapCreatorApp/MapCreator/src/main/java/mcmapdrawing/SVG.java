...
public class SVG implements DrawingModuleInterface {
    ...
    public void addPolyline(ArrayList<Point> points) {
        ...
        for (int i = 1; i < s; i++) {
            writerSVG.print(" " + points.get(i).getX() + "," + points.get(i).getY());
        }
        writerSVG.print("\" style=\"stroke:" + color + "; stroke-width:" + strokeWidth + "; fill:none; stroke-linejoin:" + polylineLinejoin + "; stroke-linecap:" + polylineLinecap + ";\" />\n");

        writerHTML.print("   <polyline points=\"" + points.get(0).getX() + "," + points.get(0).getY());
        for (int i = 1; i < s; i++) {
            writerHTML.print(" " + points.get(i).getX() + "," + points.get(i).getY());
        }
        //writerHTML.print( "\" />\n" );
    ...
    public void addCircle(int x, int y, int r) {
        writerSVG.println("   <circle cx=\"" + x + "\" cy=\"" + y + "\" r=\"" + r + "\" stroke=\"" + color + "\" stroke-width=\"" + strokeWidth + "\" fill=\"" + fillColor + "\" />");
        writerHTML.println("   <circle cx=\"" + x + "\" cy=\"" + y + "\" r=\"" + r + "\" stroke=\"" + color + "\" stroke-width=\"" + strokeWidth + "\" fill=\"" + fillColor + "\" />");
...
//ŁAMANE
    ...
    public void addPolylineStyle(String polylineColorp, int polylineWidthp, String polylineLinejoinp, String polylineLinecapp, String polylineColorHoverp, int polylineWidthHoverp) {
        ...
        writerHTML.println("\tpolyline{");
        if (polylineColorp != "") {
            writerHTML.println("\t\tstroke:\t" + polylineColorp + ";");
        }
        if (polylineWidthp != 0) {
            writerHTML.println("\t\tstroke-width:\t" + polylineWidthp + ";");
        }
        writerHTML.println("\t\tfill:\tnone;");
        if (polylineLinejoinp != "") {
            writerHTML.println("\t\tstroke-linejoin:\t" + polylineLinejoinp + ";");
        }
        if (polylineLinecapp != "") {
            writerHTML.println("\t\tstroke-linecap:\t" + polylineLinecapp + ";");
        }
        writerHTML.println("\t}");
        writerHTML.println("\tpolyline:hover{");
        if (polylineColorHoverp != "") {
            writerHTML.println("\t\tstroke:\t" + polylineColorHoverp + ";");
        }
        if (polylineWidthHoverp != 0) {
            writerHTML.println("\t\tstroke-width:\t" + polylineWidthHoverp + ";");
        }
        writerHTML.println("\t\tfill:none;");
        if (polylineLinejoinp != "") {
            writerHTML.println("\t\tstroke-linejoin:\t" + polylineLinejoinp + ";");
    ...
    public void addPolyline(ArrayList x, ArrayList y) {
        ...
        for (int i = 1; i < s; i++) {
            writerSVG.print(" " + x.get(i) + "," + y.get(i));
        }
...
//KÓŁKA
    ...
    public void addCircleStyle(String circleStrokeColorp, int circleStrokeWidthp, String circleFillp, String circleStrokeColorHoverp, int circleStrokeWidthHoverp, String circleFillHoverp) {
        writerHTML.println("<style>");
        writerHTML.println("\tcircle{");
        if (circleStrokeColorp != "") {
            writerHTML.println("\t\tstroke:\t" + circleStrokeColorp + ";");
        }
        if (circleStrokeWidthp != 0) {
            writerHTML.println("\t\tstroke-width:\t" + circleStrokeWidthp + ";");
        }
        if (circleFillp != "") {
            writerHTML.println("\t\tfill:\t" + circleFillp + ";");
        }
        writerHTML.println("\t}");
        writerHTML.println("\tcircle:hover{");
        if (circleStrokeColorHoverp != "") {
            writerHTML.println("\t\tstroke:\t" + circleStrokeColorHoverp + ";");
        }
        if (circleStrokeWidthHoverp != 0) {
            writerHTML.println("\t\tstroke-width:\t" + circleStrokeWidthHoverp + ";");
        }
        if (circleFillHoverp != "") {
            writerHTML.println("\t\tfill:" + circleFillHoverp + ";");
        }
        writerHTML.println("\t}");
        writerHTML.println("</style>");
        writerHTML.println("");
...
//PROSTOKĄTY
    ...
    public void addRectangleStyle(String rectangleStrokeColorp, int rectangleStrokeWidthp, String rectangleColorp, String rectangleStrokeColorHoverp, int rectangleStrokeWidthHoverp, String rectangleColorHoverp) {
        writerHTML.println("<style>");
        writerHTML.println("\trect{");
        if (rectangleStrokeColorp != "") {
            writerHTML.println("\t\tstroke:\t" + rectangleStrokeColorp + ";");
        }
        if (rectangleStrokeWidthp != 0) {
            writerHTML.println("\t\tstroke-width:\t" + rectangleStrokeWidthp + ";");
        }
        if (rectangleColorp != "") {
            writerHTML.println("\t\tfill:\t" + rectangleColorp + ";");
        }
        writerHTML.println("\t}");
        writerHTML.println("\trect:hover{");
        if (rectangleStrokeColorHoverp != "") {
            writerHTML.println("\t\tstroke:\t" + rectangleStrokeColorHoverp + ";");
        }
        if (rectangleStrokeWidthHoverp != 0) {
            writerHTML.println("\t\tstroke-width:\t" + rectangleStrokeWidthHoverp + ";");
        }
        if (rectangleColorHoverp != "") {
            writerHTML.println("\t\tfill:" + rectangleColorHoverp + ";");
        }
        writerHTML.println("\t}");
        writerHTML.println("</style>");
        writerHTML.println("");
...
//ELIPSY
    ...
    public void addEllipseStyle(String ellipseStrokeColorp, int ellipseStrokeWidthp, String ellipseColorp, String ellipseStrokeColorHoverp, int ellipseStrokeWidthHoverp, String ellipseColorHoverp) {
        writerHTML.println("<style>");
        writerHTML.println("\tellipse{");
        if (ellipseStrokeColorp != "") {
            writerHTML.println("\t\tstroke:\t" + ellipseStrokeColorp + ";");
        }
        if (ellipseStrokeWidthp != 0) {
            writerHTML.println("\t\tstroke-width:\t" + ellipseStrokeWidthp + ";");
        }
        if (ellipseColorp != "") {
            writerHTML.println("\t\tfill:\t" + ellipseColorp + ";");
        }
        writerHTML.println("\t}");
        writerHTML.println("\tellipse:hover{");
        if (ellipseStrokeColorHoverp != "") {
            writerHTML.println("\t\tstroke:\t" + ellipseStrokeColorHoverp + ";");
        }
        if (ellipseStrokeWidthHoverp != 0) {
            writerHTML.println("\t\tstroke-width:\t" + ellipseStrokeWidthHoverp + ";");
        }
        if (ellipseColorHoverp != "") {
            writerHTML.println("\t\tfill:" + ellipseColorHoverp + ";");
        }
        writerHTML.println("\t}");
        writerHTML.println("</style>");
        writerHTML.println("");
